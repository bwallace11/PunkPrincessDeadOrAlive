...
const slides = [
    {
        ...
        content: `
            <div class="text-center space-y-6">
                ...
                <img src="images/eyeeee.png" alt="all seeing eye" style="width: 250px; height: 200px; display: flex; justify-content: center; align-items: center; width: 100%; margin: 0 auto;"></div>
